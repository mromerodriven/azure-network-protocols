...
- Install Wireshark
- Ping VM2 from VM1
- Create a rule to deny any ICMP incoming traffic on VM2
...
<p>
<img src="https://i.imgur.com/79SnoxO.png" height="80%" width="80%"/>
</p>
<p>
Now that you've created the rule and added it, you can observe in Powershell and Wireshark that the ping is being blocked. In Powershell you'll see "Request timed out". In Wireshark, you see requests, but no replies. Congrats, you've done it. You've succesfully block incoming traffic.
</p>
<br />
